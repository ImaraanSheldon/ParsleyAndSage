...
let mihleProducts = JSON.parse(localStorage.getItem('mihleProducts')) ||[
  {
    id: 5,
    artwork_Img:
...
localStorage.setItem("mihleProducts", JSON.stringify(mihleProducts));

// Function to display recent products
function linganiProducts() {
  try {
      let latestProducts = mihleProducts.slice(0, 4); // Slice the array to get the latest 3 products
